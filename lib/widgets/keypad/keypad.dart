        ...
        builder: (context, standardProv, _) => Row(
          ...
          children: [
            KeyPadButton(
                ...
                onPressed: () =>
                    standardProv.useOperator("%", historyProv.addToHistory),
                disable: standardProv.errorOccurred,
                child: Text("%",
                    style: TextStyle(
                      fontSize: 24,
                      color: standardProv.errorOccurred
          ...
          children: [
            ...
            KeyPadButton(
                ...
                onPressed: () {
                  ...
                  } else if (!standardProv.rightUsed &&
                  ...
                  standardProv.calc(
                      'sqr(${trimTrailingZeros(standardProv.screenText)})');
                },
                child: LaTexT(
                  laTeXCode: Text(r" $x^2$",
            ...
            KeyPadButton(
                ...
                onPressed: () {
                  ...
                  standardProv.calc(
                      'sqrt(${trimTrailingZeros(standardProv.screenText)})');
                },
                child: LaTexT(
                  laTeXCode: Text(r"$\sqrt[2]{x}$ ",
                      style: TextStyle(
                        color: standardProv.errorOccurred
                            ? const Color.fromRGBO(120, 120, 120, 1)
                            : Colors.white,
          ...
          children: [
            KeyPadButton(
                ...
                child: Text("2ⁿᵈ",
                    style: TextStyle(
                      fontSize: 20,
                      color: scientificProv.errorOccurred
                          ? const Color.fromRGBO(120, 120, 120, 1)
                          : (scientificProv.second
                              ? Colors.black
                              : Colors.white),
                      fontWeight: FontWeight.w400,
                    ))),
            KeyPadButton(
                ...
                height: MediaQuery.of(context).size.height / 15,
                onPressed: () =>
                    scientificProv.replaceScreenTextWith(pi.toString()),
                disable: scientificProv.errorOccurred,
                child: LaTexT(
                  laTeXCode: Text(r" $\pi$ ",
                      style: TextStyle(
            ...
            KeyPadButton(
                ...
                height: MediaQuery.of(context).size.height / 15,
                onPressed: () =>
                    scientificProv.replaceScreenTextWith(e.toString()),
                disable: scientificProv.errorOccurred,
                child: LaTexT(
                  laTeXCode: Text(r" $e$ ",
                      style: TextStyle(
            ...
            KeyPadButton(
              ...
              child: Text(
                  scientificProv.clearAll || scientificProv.calculated
                      ? "C"
                      : "CE",
        ...
        builder: (context, scientificProv, _) => Row(
          ...
          children: [
            KeyPadButton(
                ...
                activeColor: const Color.fromRGBO(60, 60, 60, 1),
                height: MediaQuery.of(context).size.height / 15,
                onPressed: () => scientificProv
                    .useFunc(scientificProv.second ? 'cube(' : 'sqr('),
                disable: scientificProv.errorOccurred,
                child: LaTexT(
                  laTeXCode: Text(scientificProv.second ? r" $x^3$" : r" $x^2$",
                      style: TextStyle(
                        color: scientificProv.errorOccurred
                            ? const Color.fromRGBO(120, 120, 120, 1)
                            : Colors.white,
        ...
        builder: (context, scientificProv, _) => Row(
          ...
          children: [
            KeyPadButton(
                ...
                height: MediaQuery.of(context).size.height / 15,
                onPressed: () => scientificProv
                    .useFunc(scientificProv.second ? 'cuberoot(' : 'sqrt('),
                disable: scientificProv.errorOccurred,
                child: LaTexT(
                  laTeXCode: Text(
                      scientificProv.second
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    Positioned(
                        ...
                        left: 40,
                        child: Text(
                            scientificProv.parenthesesCount.toString() == "0"
                                ? ''
                                : scientificProv.parenthesesCount.toString(),
                            style: const TextStyle(
        ...
        builder: (context, scientificProv, _) => Row(
          ...
          children: [
            KeyPadButton(
                ...
                height: MediaQuery.of(context).size.height / 15,
                onPressed: () => scientificProv
                    .useOperator(scientificProv.second ? 'yroot' : '^'),
                disable: scientificProv.errorOccurred,
                child: LaTexT(
                  laTeXCode: Text(
        ...
        builder: (context, scientificProv, _) => Row(
          ...
          children: [
            KeyPadButton(
                ...
                height: MediaQuery.of(context).size.height / 15,
                onPressed: () => scientificProv
                    .useFunc(scientificProv.second ? '2^(' : '10^('),
                disable: scientificProv.errorOccurred,
                child: LaTexT(
                  laTeXCode:
                      Text(scientificProv.second ? r" $2^x$" : r" $10^x$",
                          style: TextStyle(
                            color: scientificProv.errorOccurred
                                ? const Color.fromRGBO(120, 120, 120, 1)
                                : Colors.white,
        ...
        builder: (context, scientificProv, _) => Row(
          ...
          children: [
            KeyPadButton(
                ...
                child: LaTexT(
                  laTeXCode: Text(scientificProv.second ? r"$log_yx$" : "log",
                      style: TextStyle(
                        color: scientificProv.errorOccurred
                            ? const Color.fromRGBO(120, 120, 120, 1)
                            : Colors.white,
        ...
        builder: (context, scientificProv, _) => Row(
          ...
          children: [
            KeyPadButton(
                ...
                height: MediaQuery.of(context).size.height / 15,
                onPressed: () => scientificProv
                    .useFunc(scientificProv.second ? 'e^(' : 'ln('),
                disable: scientificProv.errorOccurred,
                child: LaTexT(
                  laTeXCode: Text(scientificProv.second ? r" $e^x$" : "ln",
                      style: TextStyle(
                          color: scientificProv.errorOccurred
                              ? const Color.fromRGBO(120, 120, 120, 1)
                              : Colors.white,
