...
class MemoryList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<StandardMemoryProvider>(
        builder: (context, memoryProv, _) => memoryProv.memory.isNotEmpty
            ? Column(
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index) => Dismissible(
                            ...
                            onDismissed: (direction) =>
                                memoryProv.removeMemory(index),
                            child: MemoryTile(
                                value: memoryProv.memory[index],
                                index: index))),
                  ),
                  TextButton(
            ...
            : const Center(
                child: Text("There's nothing saved in memory",
