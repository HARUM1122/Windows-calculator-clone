        ...
        children:[
          ...
          MemoryButton(
            ...
            onPressed: (){
              ...
              standardProv
              ..screenText = addCommas(standardToScientific(memoryProv.memory[0].toString()))
              ..notify();
            },
            disable:memoryProv.memory.isEmpty||standardProv.errorOccurred
          ),
          ...
          MemoryButton(
            ...
            onPressed: (){
              ...
              if(!standardProv.rightUsed&&standardProv.currentOperator.isNotEmpty){
                standardProv.right = standardProv.left;
              }
              memoryProv.addToMemory(num.parse(trimTrailingZeros(standardProv.screenText)));
            },
            disable:standardProv.errorOccurred
          ),
          MemoryButton(
