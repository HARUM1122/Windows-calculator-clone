...
class MemoryTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final ScientificMemoryProvider memoryProv = Provider.of<ScientificMemoryProvider>(context,listen:false);
    final ScientificCalcProvider scientificCalcProv = Provider.of<ScientificCalcProvider>(context,listen:false);
    final String val = addCommas(standardToScientific(value.toString(),pos:1e20,neg:-1e20));
    return Padding(
              ...
              Row(
                ...
                children: [
                  ElevatedButton(
                    ...
                    onPressed: ()=>memoryProv.updateMemory(index,scientificCalcProv, true),
                    child:const Text("M+"),
                  ),
                  ...
                  ElevatedButton(
                    ...
                    onPressed: ()=>memoryProv.updateMemory(index,scientificCalcProv, false),
                    child:const Text("M-"),
                  ),
                ],
              )
