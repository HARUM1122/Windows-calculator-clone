...
class DurationTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final DateCalcProvider datecalcProv = Provider.of<DateCalcProvider>(context,listen:false);
    bool selected=false;
    switch(option){
      case 0:
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color:selected?const Color.fromRGBO(56, 56, 56,1):Colors.transparent,
          ...
          children: [
            Container(
              ...
              decoration:BoxDecoration(
                ...
                color:selected?const Color.fromRGBO(118, 185, 237,1):Colors.transparent
              )
            ),
