        ...
        child: Column(
          ...
          children: [
            ...
            Consumer<ScientificCalcProvider>(
              builder: (context, scientificProv, _) => SizedBox(
                height: MediaQuery.of(context).size.height / 18,
                child: TextButton(
                    onPressed: scientificProv.errorOccurred
                        ? null
                        : scientificProv.changeAngleUnit,
                    style: const ButtonStyle(
                        backgroundColor:
                            MaterialStatePropertyAll<Color>(Colors.transparent),
                        overlayColor: MaterialStatePropertyAll<Color>(
                            Colors.transparent)),
                    child: Text(scientificProv.currentAngleUnit.first,
                        style: TextStyle(
            ...
            Consumer<ScientificCalcProvider>(
              builder: (context, scientificProv, _) => Row(children: [
                SizedBox(
                  height: MediaQuery.of(context).size.height / 18,
                  child: TextButton(
                      onPressed: scientificProv.errorOccurred
                          ? null
                          : () => showD(context, const TrigonometryDialog()),
                      style: const ButtonStyle(
                        backgroundColor:
                            MaterialStatePropertyAll<Color>(Colors.transparent),
                        overlayColor:
                ...
                SizedBox(
                  ...
                  child: TextButton(
                      onPressed: scientificProv.errorOccurred
                          ? null
                          : () => showD(context, const FunctionsDialog()),
                      style: const ButtonStyle(
