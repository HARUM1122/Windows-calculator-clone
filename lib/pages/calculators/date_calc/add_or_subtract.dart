        ...
        builder: (context, dateProv, _) => Column(
          ...
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.start,
              children: [
                SelectDurationButton(dateProv: dateProv, option: 0),
                const SizedBox(width: 10),
                SelectDurationButton(dateProv: dateProv, option: 1),
                const SizedBox(width: 10),
                SelectDurationButton(dateProv: dateProv, option: 2)
              ],
            ),
            const SizedBox(height: 40),
            const Text("Date",
            ...
            Text(
                DateFormat("EEEE, MMMM d, y")
                    .format(dateProv.date ?? dateProv.from),
    ...
    return Column(
      ...
      children: [
        ...
        ElevatedButton(
            ...
            child: Row(
              children: [
                Text(map[option]![1], style: const TextStyle(fontSize: 18)),
